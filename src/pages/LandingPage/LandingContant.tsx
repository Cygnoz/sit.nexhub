  ...
  return (
    <div className="grid grid-cols-12 relative">
        ...
        <div className="grid grid-cols-12 gap-3">
          <div className="col-span-5">
            <div
              ...
              className={`w-[100%]  h-[260px] rounded-2xl ${
                mode ? "bg-[#DED0B9]" : "bg-[#565148]"
          ...
          <div className="col-span-3">
            <div
              className={`w-[98%] rounded-2xl ${
                mode ? "bg-[#C9CCBA]" : "bg-[#3A3E40]"
              }  h-[304px] px-4 py-6 relative z-50`}
            >
              <img
                src={customerVector}
                className="absolute bottom-[2px] -z-10 right-3"
                alt=""
              />
              <div className="flex justify-between items-center">
                <button
                  className={` ${
                    mode ? "bg-[#71736B]" : "bg-[#495053]"
          ...
          <div className="col-span-3">
            <div
              className={`w-[98%] rounded-2xl ${
                mode ? "bg-[#DFE1E2]" : "bg-[#585953]"
              }  h-[304px] z-50  relative px-4 py-6`}
            >
              <img
                src={purchaseVector}
              ...
              <div className="flex justify-between items-center">
                <button
                  className={`${mode ? "bg-white" : "bg-[#71736B]"} ${
                    mode ? "text-[#303F58]" : "text-white"
          ...
          <div className="col-span-3">
            <div
              className={`w-[98%] rounded-2xl relative  ${
                mode ? "bg-[#DFE1E2]" : "bg-[#283035]"
              } h-[304px] px-4 py-6 z-50`}
            >
              <img
                src={expenseVector}
          ...
          <div className="col-span-3">
            <div
              className={`w-[95%] rounded-2xl  ${
                mode ? "bg-[#F7E7CE]" : "bg-[#626552]"
              } relative h-[304px] px-4 py-6 z-50`}
            >
              <img
                src={supplierVector}
      ...
      <div className="col-span-3 space-y-4">
        <div
          className={`w-[100%] h-[437px] rounded-2xl relative ${
            mode ? "bg-[#CFAE7D]" : "bg-[#948B7C]"
          } px-4 py-6 z-50`}
        >
          <img
            src={accVector1}
        ...
        >
          ...
          />
          <p
            className={`w-[140px] text-[16px]  absolute right-14 bottom-5 ${
              mode ? "text-[#303F58]" : "text-white"
            }`}
          >
            Chat With <br />
      ...
      <div>
        <button
          className={`absolute z-60 right-[50%] translate-x-[50%] ${
            mode ? "bg-white" : "bg-[#1A282F]"
          } rounded-full -bottom-6 h-[55px] w-[150px] flex items-center rotate-border shadow-xl`}
        ></button>
        <button
          className={`absolute z-70 right-[50%] translate-x-[50%] ${
            mode ? "bg-white" : "bg-[#1A282F]"
          } rounded-full -bottom-5 px-4 py-3 ${
            mode && "text-[#C2A270]"
          } flex items-center`}
          onClick={() => {
            document
...
url={`https://dev.solytics.online/main?projectName=Sewnex`}
/>
}
    </div>
  );
