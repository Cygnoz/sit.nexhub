    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      <div className="flex justify-between items-center mb-4 gap-2">
        ...
        <div className="flex justify-center items-center">
          <h4 className="font-bold text-xl text-textColor "> {accountSubHead} Account </h4>
        </div>
        ...
        <table className="w-full text-[#495060]">
          ...
          <tbody className="text-xs ">
            {item?.accounts?.map((items:any) => (
             ...
             <Link to={`/reports/trialBalance/${accountSubHead}/monthly-summery`} state={{items}} > <td className="py-3">{items.accountName}</td></Link>
