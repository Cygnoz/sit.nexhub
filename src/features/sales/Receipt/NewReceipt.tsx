...
<div className="col-span-7">
  ...
  <div className="relative w-full">
    <div className="flex items-center space-x-4">
      <label className="flex items-center text-sm text-labelColor-">
        <input 
          type="radio" 
          name="taxDeducted" 
          value="Petty Cash" 
          className="text-inputBorder focus:ring-0"
        />
        <span className="ml-2">No Tax Deducted</span>
      </label>
      <label className="flex items-center text-sm text-labelColor-">
        <input 
          type="radio" 
          ...
          className="text-inputBorder focus:ring-0"
        />
        <span className="ml-2">Yes,TDS (Income Tax)</span>
      </label>
    </div>
  </div>
</div>
