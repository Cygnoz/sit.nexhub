...
exports.getTopCustomers = async (req, res) => {
    try {
        ...
        console.log("Error fetching top customers:", error);
        res.status(500).json({ message: "Internal server error.", error });
    }
};
...
exports.getCustomerRetentionOverTime = async (req, res) => {
    try {
        ...
        console.log("Error fetching customer retention over time:", error);
        res.status(500).json({ message: "Internal server error.", error });
    }
};
...
exports.getAverageOrderValue = async (req, res) => {
    try {
        ...
        console.log("Error fetching average order value:", error);
        res.status(500).json({ message: "Internal server error.", error });
    }
};
