...
const iconDataMap: any = {
  All: [
    ...
    { icon: creditNote, label: "Credit Note", route: "/sales/credit-note", index: 3, subIndex: 6 },
    // { icon: salesReturn, label: "Sales Return", route: "/item-tracking", index: 5, subIndex: 2 },
    { icon: purchasOrder, label: "Purchase Order", route: "/purchase/purchase-order", index: 7, subIndex: 1 },
    { icon: posIcon, label: "POS", route: "/pos", state: { from: "/landing" }, index: 0, subIndex: 0, },
    { icon: bills, label: "Bills", route: "/purchase/bills", index: 7, subIndex: 2 },
    { icon: PaymentMade, label: "Payment Made", route: "/purchase/payment-made", index: 7, subIndex: 3 },
    { icon: debitNote, label: "Debit Note", route: "/purchase/debitnote", index: 7, subIndex: 4 },
    ...
    { icon: daybook, label: "Day Book", route: "/reports/daybook", index: 8, subIndex: 5 },
    ...
    { icon: report, label: "Report", route: "/reports", index: 8, subIndex: 0 },
  ],
  Sales: [
    { icon: salesOrder, label: "Sales Order", route: "/sales/salesorder", index: 3, subIndex: 1 },
    { icon: quotes, label: "Quotes", route: "/sales/quote", index: 3, subIndex: 2 },
  ...
  Settings: [
    ...
    { icon: prefernces, label: "Preferences", route: "/settings/preferences/CustomerAndSupplier", index: 0, subIndex: 0 },
