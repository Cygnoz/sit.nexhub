...
function SubscriptionDrawer({ mode }: Props) {
  ...
  return (
    <div>
      ...
      >
        <div className={`${!mode ? "bg-[#21282C] text-[#FCF8ED]" :"bg-[#FDF8F0] text-[#4B5C79]"} p-8`}>
          <p
          ...
          <div className="mt-2 flex justify-between items-center">
            ...
            <Button variant={!mode ? "secondary" : "fourthiary"} className="h-8 pl-7 pr-7">
              Trial
            </Button>
          </div>
        </div>
        ...
        <div className={`p-12 ${!mode ? "text-white" :"text-[#4B5C79]"}`}>
          <div className={`mb-10 flex justify-between items-center border-b border-[#2C353B] pb-5`}>
          ...
          <div className="mb-7 flex justify-between items-center border-b border-[#2C353B] pb-5">
        ...
        <div className="p-6">
          <p className="text-[#FCF8ED] text-base font-medium mb-4">
            Point of Contact
          </p>
          <div className="bg-[#21282C] p-6 rounded-xl flex items-center gap-5">
            <img
              src={defaultImage}
